 ...
 * Class Sets
 *
 * @property \App\Sets $model
 *
 * @see http://sleepingowladmin.ru/docs/model_configuration_section
 */
class Sets extends Section implements Initializable
{
        ...
        $form = \AdminForm::panel()
            ->addBody([
                    \AdminFormElement::columns()
                        ...
                        ->addColumn([
                            \AdminFormElement::image('image', 'Основное изображение (должно быть квадратным. Желательная ширина и высота по 360px)')->required(),
                        ], 7)
                        ->addColumn([
                            \AdminFormElement::images('images', 'Дополнительные изображения (Для слайдера)'),
                        ], 12)
                ]
            );
        return $form;
